...
const char* tilesheet_paths[] = {
    ...
    [FOREST_SPRING] = "../../assets/Tilesets/FG_Forest_Sprint.png",
    ...
    [GRASSLANDS_FALL] = "../../assets/Tilesets/FG_Grasslands_Full.png",
...
SDL_Texture* load_tilesheet(SDL_Renderer* renderer, tilesheet_t file_path) {
